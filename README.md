...
- **It's an R290 (propane) unit** — deduced from the `PctLEL` leak sensors and
  ...
  saturation curve exactly (the history chart's Cond A/B series uses this).
