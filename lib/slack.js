...
// Supply minus setpoint in integer tenths (like lib/boost.js decide): float
// subtraction of the scaled x10 values makes an exactly-13.0°F margin trip for
// some setpoint values and not others.
const over10 = (/** @type {State} */ s) => Math.round((scale(s.regs[68]) - scale(s.regs[70])) * 10);
...
const CONDITIONS = [
  ...
  { key: "glycol-boost", level: "🟠", title: `Glycol supply within ${TRIP_F - BOOST_MARGIN_F}°F of the shutdown trip`, source: "regs", dwellMs: minute(HIGH_DWELL),
  ...
  { key: "glycol-boost-urgent", level: "🚨", title: `Glycol supply within ${TRIP_F - BOOST_URGENT_F}°F of the shutdown trip`, source: "regs", dwellMs: 0,
    test: (/** @type {State} */ s) => process.env.SETPOINT_WRITE !== "1" &&
