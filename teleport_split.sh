...
# out the home LAN; adding 192.168.4.0/22 keeps the chiller site on the tunnel, whose
...
sudo route -n add -net 192.168.4.0/22 -interface "$TUN" >/dev/null 2>&1 || true
echo "Split active: internet via en0, chiller LAN (192.168.4.0/22) via $TUN"
